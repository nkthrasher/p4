...
#define DIALOG_EVENT		11	/* dialog box for warnings */
#define UNSUSPEND_EVENT		12	/* resume player's game */
#define GAME_MARKER		13	/* only game events follow */
	/* ASAP events */
...
#define SZ_OUT_BUFFER		512	/* largest possible server message */
